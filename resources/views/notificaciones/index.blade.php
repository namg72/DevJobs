                ...
                <div class="p-6 bg-white border-b border-gray-200 text-gray-900">
                    ...
                    <div class="p-5 border border-gray-200 lg:flex lg:justify-between items-center">
                        <div>
                            ...
                            <P>
                                <span class="font-bold capitalize">{{$notificacion->created_at->diffForHumans()}}</span>
                            </P>
                        </div>
                        <div class="mt-5 lg:mt-0">
                            <a href="{{route('candidatos.index', $notificacion->data['id_vacante'])}}"
                                class="border p-2 bg-indigo-500 text-sm text-white font-bold rounded-lg">Candidatos</a>
                        </div>
                    </div>
