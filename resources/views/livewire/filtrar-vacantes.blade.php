<div class="bg-gray-100 py-10">
    ...
    <div class="max-w-7xl mx-auto">
        <form wire:submit.prevent='leerDatosFoumulario'>
    ...
    <h1 class="w-full text-4xl mt-4 text-center font-bold">NO FUNCIONA EL BUSCADOR POR EL EMIT VER LOS VIDOES 250-252
        DEL
        CURSO</h1>
</div>